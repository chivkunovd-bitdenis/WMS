...
- Если в контракте есть `## Макет`, до кода открой указанный `MOCKUP.html` и реализуй именно
  его на существующем UI-kit. Нет файла — не импровизируй и не создавай `DEV.md`.
- Новый общий визуальный примитив сначала реализуется отдельным атомом в
  `frontend/src/ui-kit/` с тестом; экран не копирует его локальную вёрстку.
