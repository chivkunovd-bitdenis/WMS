...
```json
{
  ...
  "blocker": {
    ...
    "details": "BLK-ARCH-003: Ozon и аналитический модуль требуют dossier/ARCH до разработки",
    "owner": "solution-architect",
    "created_at": "2026-08-21T00:28:09Z",
    "resume_stage": "S03"
  },
  "resume_condition": {
    "stage": "S03",
    "condition": "resolve BLK-ARCH-003 with closure evidence"
  },
  "rules": [
...
```bash
python3 scripts/pipeline/run.py advance --task-id BLG-G01 --stage S03 --verdict <ALLOWED_VERDICT> --role pipeline-ba --agent <agent-id> --executor codex --model gpt-5.6-sol --tier expensive --input-tokens <INPUT_TOKENS> --output-tokens <OUTPUT_TOKENS> --estimated-usd <USD>
