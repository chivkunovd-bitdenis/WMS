...
```bash
python3 scripts/pipeline/run.py advance --task-id BLG-J01 --stage S18 --verdict <ALLOWED_VERDICT> --role pipeline-dev --agent <agent-id> --executor codex --model gpt-5.6-luna --tier cheap --input-tokens <INPUT_TOKENS> --output-tokens <OUTPUT_TOKENS> --estimated-usd <USD>
