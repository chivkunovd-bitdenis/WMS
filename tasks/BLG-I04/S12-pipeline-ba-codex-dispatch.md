...
```json
{
  ...
  "backlog_item_id": "BLG-I04",
  "backlog_item": {
    "id": "BLG-I04",
    "title": "Исправить квадратирование числа листов при печати",
    "source_section": "I4",
...
```bash
python3 scripts/pipeline/run.py next --task-id BLG-I04
python3 scripts/pipeline/run.py validate --task-id BLG-I04
```
...
```bash
python3 scripts/pipeline/run.py advance --task-id BLG-I04 --stage S12 --verdict <ALLOWED_VERDICT> --role pipeline-ba --agent <agent-id> --executor codex --model gpt-5.6-terra --tier moderate --input-tokens <INPUT_TOKENS> --output-tokens <OUTPUT_TOKENS> --estimated-usd <USD>
python3 scripts/pipeline/run.py packet --task-id BLG-I04
python3 scripts/pipeline/dispatch.py --task-id BLG-I04 --executor codex
```
