...
Reasons:
- stage S15 / role pipeline-ba default tier is moderate
...
```json
{
  ...
  "budget_usage": {
    "input_tokens": 270300,
    "output_tokens": 19100,
    "estimated_usd": 1.8525
  },
  "blocked_by": [],
  "blocker": {
    "type": "OWNER_INPUT",
    "reason_code": "CASE_AUDIT_REQUIRED",
    "details": "S15 case matrix is complete, but the pipeline-ba case writer cannot independently issue CASE_AUDIT_PASSED; S16 must not proceed without a distinct case-auditor review of the exact S15 artifacts.",
    "owner": "denis",
    "created_at": "2026-08-21T01:17:33Z",
    "resume_stage": "S15"
  },
  "resume_condition": {
    "stage": "S15",
    "condition": "A distinct case-auditor records CASE_AUDIT_PASSED for tasks/BLG-D05/S15-CASE-FACTORY.md and tasks/BLG-D05/S15-CASES.json; controller then resumes S15 for the allowed verdict."
  },
  "rules": [
...
```bash
python3 scripts/pipeline/run.py advance --task-id BLG-D05 --stage S15 --verdict <ALLOWED_VERDICT> --role pipeline-ba --agent <agent-id> --executor codex --model gpt-5.6-terra --tier moderate --input-tokens <INPUT_TOKENS> --output-tokens <OUTPUT_TOKENS> --estimated-usd <USD>
