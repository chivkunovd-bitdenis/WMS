...
- **Оставшийся осознанный риск:** если WB-справочник не содержит имя склада, фильтр показывает fallback `WB <id>`. Это честнее, чем выводить WMS-склад или «Склад WB неизвестен».
