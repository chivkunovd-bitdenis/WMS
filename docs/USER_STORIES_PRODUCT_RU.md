...
| ID | Статус | User story |
|----|--------|------------|
| **US-C-01** | Частично | **Как приёмщик**, **позже** (когда дошли до короба по внутреннему ШК) я хочу **поштучно** принять товар и **разложить по ячейкам**, чтобы остаток был привязан к адресу. |
| **US-C-02** | Запланировано | **Как приёмщик**, при раскладке я хочу, чтобы система **подсказывала ячейки, где уже лежит этот товар**, чтобы класть в то же место. |
| **US-C-03** | Частично | **Как приёмщик**, при назначении ячейки я хочу **напечатать штрихкод ячейки**, чтобы наклеить и сканировать при следующих операциях. |
| **US-C-04** | Запланировано | **Как приёмщик**, я хочу видеть строку **зелёным**, если поштучный факт **совпал с ожидаемым**, чтобы сразу понимать «всё ок». |
| **US-C-05** | Запланировано | **Как кладовщик**, я хочу видеть **остаток без ячейки** выделенным **отдельным цветом**, чтобы сразу видеть «ещё не разложено». |
| **US-C-06** | Частично / баг | **Как приёмщик**, я хочу **найти товар по штрихкоду** и добавить строку в приёмку; *у заказчика сейчас поиск не работает — отдельный дефект*. |
