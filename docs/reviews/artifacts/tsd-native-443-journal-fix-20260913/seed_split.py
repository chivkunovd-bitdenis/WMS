...
async def main():
 ...
 async with SessionLocal() as db:
  ...
  actor_b=await db.get(User,uuid.UUID('b1277336-0fec-468c-9ecc-eb143e665d4d'))
  a=await create_location(db,tenant,wh,code='FINAL-JOURNAL2-A-5da311');b=await create_location(db,tenant,wh,code='FINAL-JOURNAL2-B-5da311')
