...
URL='postgresql+psycopg_async://deniscivkunov@localhost:5432/wms444_astra_rereview_20260913'
engine=create_async_engine(URL)
sf=async_sessionmaker(engine,expire_on_commit=False)

async def main():
    async with engine.begin() as c:
        assert (await c.execute(select(func.current_database()))).scalar_one()=='wms444_astra_rereview_20260913'
