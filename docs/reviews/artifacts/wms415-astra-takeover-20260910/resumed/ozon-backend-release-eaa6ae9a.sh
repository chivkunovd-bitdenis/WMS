...
set -euo pipefail
cd /opt/wms
TARGET_SHA=eaa6ae9aecee875c50b31afa6b2cc224bb57d043
BASE_SHA=0771833b7389260042f03a47abc7821e3a47fcb4
...
EXPECTED_APP_FILES=$'backend/app/services/ozon_fbs_marking_gate_service.py\nbackend/app/services/ozon_fbs_sync_service.py'
test "$(git diff --name-only "$BASE_SHA" "$TARGET_SHA" -- backend/app)" = "$EXPECTED_APP_FILES"
