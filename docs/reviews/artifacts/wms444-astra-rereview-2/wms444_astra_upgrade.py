...
target=root/'.local-run/wms444-review3-migration-tree'
...
url='postgresql+psycopg://deniscivkunov@localhost:5432/wms444_astra_upgrade3_20260913'
engine=create_engine(url)
with engine.connect() as conn:
    assert conn.scalar(text('select current_database()'))=='wms444_astra_upgrade3_20260913'
