...
URL='postgresql+psycopg_async://deniscivkunov@localhost:5432/wms444_astra_c20_20260913'
...
async def main():
    async with engine.begin() as c:
        assert (await c.execute(select(func.current_database()))).scalar_one()=='wms444_astra_c20_20260913'
