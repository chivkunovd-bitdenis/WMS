...
[Сохранённые строки worker](artifacts/wms410-fashion-20260909/prod-worker-scoped.log), [26 целей и статусы](artifacts/wms410-fashion-20260909/prod-2103525-targets.json), [production bindings и агрегаты](artifacts/wms410-fashion-20260909/prod-writer-readonly.txt).
