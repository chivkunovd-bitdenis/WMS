...
- Основной браузерный сценарий: основной каталог остался неизменным; в нижней плашке введён внутренний ШК короба, нужный короб автоматически раскрыт и подсвечен, товар и текущий остаток показаны.
