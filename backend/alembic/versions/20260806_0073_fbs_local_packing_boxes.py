...
def upgrade() -> None:
    ...
    op.create_index("ix_fbs_packing_boxes_warehouse_box_id", "fbs_packing_boxes", ["warehouse_box_id"])
    ...
    op.create_index("ix_fbs_packing_box_items_fbs_order_id", "fbs_packing_box_items", ["fbs_order_id"])


def downgrade() -> None:
    op.drop_table("fbs_packing_box_items")
    op.drop_table("fbs_packing_boxes")
    op.drop_constraint("fk_fbs_supplies_operator_finished_by_user_id", "fbs_supplies", type_="foreignkey")
