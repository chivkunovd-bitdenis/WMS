...
OPENAPI_PATH = REPOSITORY_ROOT / "tasks/ozon-integration-20260825/OZON_RETURNS_OPENAPI.json"
GENERATED_MODELS_PATH = REPOSITORY_ROOT / "backend/app/schemas/ozon_returns_api.py"
GENERATOR_PATH = REPOSITORY_ROOT / "scripts/generate_ozon_returns_models.py"
...
def _generated_source() -> str:
    spec = spec_from_file_location("generate_ozon_returns_models", GENERATOR_PATH)
