...
_SGTIN_MISSING_GS_MESSAGE = (
    "КИЗ без GS-разделителя или без ключа проверки после серийного номера — "
    "Wildberries его отклонит. Отсканируйте DataMatrix заново или дождитесь "
    "восстановления пула кодов."
)
