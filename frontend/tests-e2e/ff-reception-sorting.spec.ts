...
// и помечает расхождение. Решение заказчика 17.08.2026: у строки один признак и один цвет — есть
// расхождение (да/нет), красным помечается только оно. Ни раскраски по статусу, ни «работы начата» больше
// нет — эти смыслы уже занимает чип статуса рядом, и два цвета для одного статуса только путали.
