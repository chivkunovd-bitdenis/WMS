const API_DETAIL_MESSAGES_RU: Record<string, string> = {
  ...
  insufficient_codes: 'Недостаточно кодов ЧЗ у селлера для печати по строке.',
  already_printed_use_reprint: 'ЧЗ по этой строке уже напечатаны — используйте «Повторная печать».',
  marking_not_done: 'Не хватает напечатанных кодов ЧЗ по заданию на упаковку.',
  ...
  pool_not_found: 'Пул кодов ЧЗ не найден.',
  empty_file: 'В файле не найдено кодов ЧЗ.',
