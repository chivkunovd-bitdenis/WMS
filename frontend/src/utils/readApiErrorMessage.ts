const API_DETAIL_MESSAGES_RU: Record<string, string> = {
  ...
  insufficient_sorting_stock:
    'В зоне «Сортировка» недостаточно этого товара. Завершите пересчёт по всем закрытым коробам и снова нажмите «Завершить пересчёт» в приёмке, либо укажите меньшее количество.',
