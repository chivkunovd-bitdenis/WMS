const API_DETAIL_MESSAGES_RU: Record<string, string> = {
  ...
  no_codes: 'Выберите хотя бы один доступный КИЗ.',
  import_request_conflict:
    'Этот запрос уже выполнен с другим файлом или выбором. Выберите файл заново и повторите.',
  invalid_row_key:
    'Список выбранных КИЗ устарел. Вернитесь к остатку и повторите выбор.',
  label_artifact_missing:
    'Для части остатка не найдена исходная PDF-этикетка. Загрузите исходный PDF заново.',
