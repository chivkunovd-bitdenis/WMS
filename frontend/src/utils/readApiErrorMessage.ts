const API_DETAIL_MESSAGES_RU: Record<string, string> = {
  ...
  product_ambiguous:
    'Этот штрихкод относится к нескольким товарам. Откройте документ с нужным селлером.',
  container_not_found: 'Открытая тара не найдена на складе. Отсканируйте её ещё раз.',
