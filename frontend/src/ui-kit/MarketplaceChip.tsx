...
/** Фирменные цвета площадок — единственный их источник в приложении. */
...
// Квадратный значок площадки для заголовков, где полное имя рядом уже есть
// или не помещается: цветной фон площадки и две буквы. Признак, не действие.
