...
![Каталог товаров: 1 — пункт меню «Каталог», 2 — кнопка «Загрузить Excel» (её и соседнюю «Создать товар» видит только администратор фулфилмента)](images/katalog-01-spisok.png)
