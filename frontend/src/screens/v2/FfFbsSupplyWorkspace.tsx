                      ...
                      return (
                        <Stack
                          ...
                          sx={{
                            ...
                            bgcolor: kizRowActive
                              ? 'info.light'
                              : tail && (!isOzonSupply || czReady)
                                ? 'success.light'
                                : (printed ? 'action.hover' : 'background.paper'),
                            borderLeft: '4px solid',
                            borderLeftColor: kizRowActive ? 'info.main' : (tail && (!isOzonSupply || czReady) ? 'success.main' : 'transparent'),
                          }}
                        ...
                        >
                          ...
                          <Box sx={{ width: 118, flexShrink: 0, textAlign: 'right' }}>
                            ...
                            {tail ? (
                              <Typography
                                sx={{ fontFamily: 'monospace', fontWeight: 700, fontSize: 15, color: isOzonSupply && !czReady ? 'text.secondary' : 'success.dark' }}
