...
export function FfProductsCatalogScreen({
  ...
  // Окно «Задать остаток» — то же, что на экране остатков FBS и в кабинете
  // селлера (WMS-469). Владелец просил, чтобы настройка жила в каталоге, а не
  // отдельным разделом. Здесь только выбор товаров одного продавца; загрузку,
  // сохранение и ошибки внутри окна ведёт FbsStockDialogContainer.
                        ...
                        <Tooltip title="Остаток для FBS">
                          <span>
                            <IconButton
                              ...
                              onClick={() => openFbsStockDialog([p.id])}
                            >
