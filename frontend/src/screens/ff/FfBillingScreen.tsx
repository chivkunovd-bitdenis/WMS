...
type SellerReportSummary = { rows: SellerReportRow[]; totals: { seller_count: number; operation_count: number; item_quantity: number; not_billable_count: number; net_total_kopecks?: number; inbound_items?: number; packing_items?: number; outbound_items?: number; fbs_items?: number; fbs_boxes?: number } }
