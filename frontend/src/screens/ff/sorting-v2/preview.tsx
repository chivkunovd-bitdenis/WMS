...
// Отдельная точка входа: /sorting.html при запущенном `npm run dev`.
export function SortingHarness() {
      ...
      <Box sx={{ px: 3, py: 1.5, bgcolor: 'text.primary', color: 'common.white' }}>
        <Stack direction="row" spacing={2} sx={{ alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <Typography variant="body2" sx={{ opacity: 0.75 }}>
            Лента макета: данные выдуманные, сервера нет. На боевом экране этой ленты не будет.
          </Typography>
          {note ? (
