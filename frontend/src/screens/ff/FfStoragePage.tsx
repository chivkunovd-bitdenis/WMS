      ...
      : !rateValidFrom
        ...
        : rateValidFrom < moscowToday
          ...
          : sellerRateEnabled && (!rateSellerId || !Number.isFinite(parsedSellerRate) || parsedSellerRate <= 0 || !sellerRateValidFrom)
            ...
            : sellerRateEnabled && sellerRateValidFrom < moscowToday
