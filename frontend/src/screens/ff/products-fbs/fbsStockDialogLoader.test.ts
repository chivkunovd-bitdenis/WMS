...
const wbRule = {
  publish: true, mode: 'units', value: 30, marketplace: 'wb', external_warehouse_id: '501001',
  wms_warehouse_id: YARTSEVO, served: true, applicable: true, on_hand: 100, reserved: 0,
  free_stock: 100, published_now: 30,
}
const ozonRule = { ...wbRule, mode: 'percent', value: 40, marketplace: 'ozon',
...
describe('loadFbsStockDialog', () => {
  it('names blocks from both cabinets when everything answers', async () => {
    ...
    expect(data.products[0]!.byBinding).toEqual({
      b1: { publish: true, mode: 'units', value: 30, applicable: true, onHand: 100, reserved: 0, freeStock: 100 },
      b2: { publish: true, mode: 'percent', value: 40, applicable: true, onHand: 100, reserved: 0, freeStock: 100 },
    })
