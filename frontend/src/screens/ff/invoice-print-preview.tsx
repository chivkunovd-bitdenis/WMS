...
const HTML = buildInvoicePrintHtml({
  ...
  lines: [
    { description: 'Приёмка товара', quantity: '1 800', unit: 'За штуку', price: '3,00 ₽', amount: '5 400,00 ₽' },
    { description: 'Упаковка заказов', quantity: '685', unit: 'За штуку', price: '5,00 ₽', amount: '3 425,00 ₽' },
    { description: 'Сборка заказов FBS', quantity: '317', unit: 'За штуку', price: '15,00 ₽', amount: '4 755,00 ₽' },
    { description: 'Хранение, литро-дни', quantity: '1 240', unit: 'За литр-день', price: '0,50 ₽', amount: '620,00 ₽' },
  ],
  total: '14 200,00 ₽',
