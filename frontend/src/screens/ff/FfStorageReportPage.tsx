 ...
 *
 * Это и есть экран пункта меню «Хранение» (адрес `ff/inventory`). По прямому
 * поручению владельца прежняя операционка — обмеры, редактор ставок, история
 * габаритов, месячные ведомости и печать — с него убрана: страница отвечает на
 * один вопрос, сколько и на сколько лежало. Бэковые сервисы хранения на месте.
 */
  ...
  return (
    <Box data-testid="ff-storage-report-page" sx={{ width: '100%', maxWidth: '100%', minWidth: 0 }}>
      ...
      <ReportMetricStrip
        items={[
          {
            // Литро-дни, а не литры: это накопленный за период объём, умноженный
            // на сутки. Плашка названа своей величиной, чтобы число не прочитали
