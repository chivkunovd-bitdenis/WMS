...
export type PickProduct = {
  ...
  name: string
  sku: string
  /** Артикул продавца из карточки маркетплейса. */
...
export const PRODUCTS: PickProduct[] = [
  { id: 'p-tshirt', name: 'Футболка хлопок белая, M', sku: 'TS-WHT-M', sellerArticle: 'TSHIRT-WHITE', barcode: '4680123456789', photo: photo('ФБ'), size: 'M' },
  { id: 'p-hoodie', name: 'Худи оверсайз серое, L', sku: 'HD-GRY-L', sellerArticle: 'HOODIE-GREY', barcode: '4680123456796', photo: photo('ХД'), size: 'L' },
  { id: 'p-jeans', name: 'Джинсы прямые синие, 32', sku: 'JN-BLU-32', sellerArticle: 'JEANS-BLUE', barcode: '4680123456802', photo: photo('ДЖ'), size: '32' },
  { id: 'p-socks', name: 'Носки спортивные, 3 пары', sku: 'SK-SPT-3', sellerArticle: 'SOCKS-SPORT', barcode: '4680123456819', photo: photo('НС'), size: null },
  { id: 'p-cap', name: 'Кепка бейсболка чёрная', sku: 'CP-BLK', sellerArticle: 'CAP-BLACK', barcode: '4680123456826', photo: photo('КП'), size: null },
  { id: 'p-belt', name: 'Ремень кожаный, 110 см', sku: 'BL-110', sellerArticle: 'BELT-LEATHER', barcode: '4680123456833', photo: photo('РМ'), size: '110' },
]
